#undef DECORATOR_DONKEYKONG_API
...
#define UE_PROJECT_NAME Decorator_DonkeyKong
#define UE_TARGET_NAME Decorator_DonkeyKongEditor
#define UE_MODULE_NAME "Decorator_DonkeyKong"
...
#define DECORATOR_DONKEYKONG_API DLLEXPORT
